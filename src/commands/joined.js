...
module.exports = {
	...
	description: "Find when a user was first seen in the channel",
	handler: args => {
        message=args.query
        // console.log(message);
		  ...
		  MongoClient.connect(mongourl, function(err, db) {
			...
			.toArray(function(err, items) {
				...
				if(items.length > 0){
					...
					console.log(usrMsgs.sender + " was first seen in [#" + usrMsgs.channel + "] " + ta.ago(usrMsgs.time) + " (" + onDate + ") saying: \"" + usrMsgs.message + "\"")
					args.send(usrMsgs.sender + " was first seen in [#" + usrMsgs.channel + "] " + ta.ago(usrMsgs.time) + " (" + onDate + ") saying: \"" + usrMsgs.message + "\"")
